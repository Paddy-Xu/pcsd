...
public interface AccountManager {
	 ...
	 */
	void credit(int branchId, int accountId, double amount)
	 ...
	 * @throws NegativeAmountException If the amount used is negative.
	 */
	void debit(int branchId, int accountId, double amount)
	    throws InexistentBranchException, InexistentAccountException,
			       NegativeAmountException;
	 ...
	 * @throws NegativeAmountException If the amount used is negative.
	 */
	void transfer(int branchId, int accountIdOrig, int accountIdDest,
	              double amount)
	    throws InexistentBranchException, InexistentAccountException,
			       NegativeAmountException;
